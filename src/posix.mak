...
$(GENSRC) : $(SRC) $(ROOT_SRC) settings.json $(MAGICPORT) id.c impcnvtab.c
	$(MAGICPORT) . .

DSRC= $(GENSRC) $(MANUALSRC)

ddmd: $(HOST_DC) $(DSRC) glue.a backend.a
	CC=$(HOST_CC) $(HOST_DC) $(MODEL_FLAG) $(DSRC) -ofddmd glue.a backend.a -debug -vtls -J.. -d -version=DMDV2 -g
